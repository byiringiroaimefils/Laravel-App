        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <br>
                    <form action="{{url('productData') }}" method="POST">
                        @csrf
                        ...
                        <tbody class="">
                            <tr class="border-y-2 border-gray-600 text-lg hover:bg-slate-500/10">
                                ...
                                <td>
                                    ...
                                    <button class="bg-red-600  hover:bg-red-500  p-0.5 w-16 rounded-full text-base">Delete</button>
                                </td>
                            </tr>
                            <tr class="border-y-2 border-gray-600 text-lg hover:bg-slate-500/10">
                                <td>02</td>
                                ...
                                <td>12-12-2024</td>
                                <td>
                                    <button class="bg-indigo-600 hover:bg-indigo-500 p-0.5 w-16 rounded-full text-base">Edit</button>
                                    <button class="bg-red-600 hover:bg-red-500 p-0.5 w-16 rounded-full text-base ">Delete</button>
                                </td>
                            </tr>
